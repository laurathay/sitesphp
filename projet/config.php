...
define("URL_TEMPLATE", PROJET_URL_SITE . "template/"); //le chemin pour le css template 2020
define("PATH_TEMPLATE", PROJET_PATH_SITE . "template/"); //definit au cas ou on en a besoin
