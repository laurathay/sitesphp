...
define("PROJET_URL_SITE", "http://localhost:8888/Decodeuse/descodeuse/"); //l'url de base definit
define("PROJET_PATH_SITE", __DIR__ . "/"); //definit au cas ou si on rappelle plus tard le chemin

define("URL_TEMPLATE", PROJET_URL_SITE . "template/site2020/"); //le chemin pour le css template 2020
define("PATH_TEMPLATE", PROJET_PATH_SITE . "template/site2020/"); //definit au cas ou on en a besoin

define("NOM_DU_PROJET", "Decodeuse");
